                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="dni" name="dni" value="{{ $history->dni }}" required readonly>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="nombres">Nombres</label>
                                        <input type="text" class="form-control form-control-sm" id="nombres" name="nombres" value="{{ $history->nombres }}" required readonly>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="fecha_nacimiento">Fecha Nacimiento</label>
                                        <input type="text" class="form-control form-control-sm" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ $history->fecha_nacimiento->format('Y-m-d') }}" onchange="getAge(this.value);" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="edad">Edad</label>
                                        <input type="text" class="form-control form-control-sm" id="edad" name="edad" value="{{ $oc[0]['age'] }}" required readonly>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="telefono" name="telefono" value="{{ $history->telefono }}" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="email" class="form-control form-control-sm" id="email" name="email" value="{{ $history->email }}" required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" id="grupo_sanguineo_id" name="grupo_sanguineo_id" required>
                                            <option value="">-- Seleccione --</option>
                                            @foreach($gs as $g)
                                                <option value="{{ $g->id }}" {{ $history->grupo_sanguineo_id == $g->id ? 'selected' : '' }}>{{ $g->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                @if($history->ubigeo_extranjero !== null)
                                    <div class="col-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" id="extranjero" name="extranjero" value="{{ $history->ubigeo_extranjero }}" placeholder="PAÍS, REGIÓN, CIUDAD">
                                ...
                                @else
                                    ...
                                    <div class="col-5">
                                        <div class="form-group nacional">
                                            ...
                                            <select class="form-control form-control-sm buscarUbigeoR" id="ubigeo_nacimiento" name="ubigeo_nacimiento">
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm buscarUbigeoR" id="ubigeo_residencia" name="ubigeo_residencia" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="direccion" name="direccion" value="{{ $history->direccion }}" required>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" id="grado_instruccion_id" name="grado_instruccion_id" required>
                                            <option value="">-- Seleccione --</option>
                                            @foreach($gi as $g)
                                                <option value="{{ $g->id }}" {{ $history->grado_instruccion_id == $g->id ? 'selected' : '' }}>{{ $g->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm buscarOcupacion" id="ocupacion_id" name="ocupacion_id" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" id="acompanante" name="acompanante" value="{{ $history->acompanante }}" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="acompanante_telefono">Acompañante teléfono</label>
                                        <input class="form-control form-control-sm" id="acompanante_telefono" name="acompanante_telefono" value="{{ $history->acompanante_telefono }}" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="acompanante_direccion">Acompañante dirección</label>
                                        <input class="form-control form-control-sm" id="acompanante_direccion" name="acompanante_direccion" value="{{ $history->acompanante_direccion }}" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="vinculo">Vínculo</label>
                                        <input class="form-control form-control-sm" id="vinculo" name="vinculo" value="{{ $history->vinculo }}" required>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="seguro_descripcion" id="seguro_descripcion" value="{{ $history->seguro_descripcion }}">
                                    </div>
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="ant_quirurgicos" id="ant_quirurgicos">{{ $history->ant_quirurgicos }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="ant_patologicos">Antecedentes patológicos</label>
                                            <textarea class="form-control form-control-sm" name="ant_patologicos" id="ant_patologicos">{{ $history->ant_patologicos }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="ant_familiares">Antecedentes familiares</label>
                                            <textarea class="form-control form-control-sm" name="ant_familiares" id="ant_familiares">{{ $history->ant_familiares }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="ant_medicos">Antecedentes médicos</label>
                                            <textarea class="form-control form-control-sm" name="ant_medicos" id="ant_medicos">{{ $history->ant_medicos }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="rams">RAMS</label>
                                            <textarea class="form-control form-control-sm" name="rams" id="rams">{{ $history->rams }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endrole
