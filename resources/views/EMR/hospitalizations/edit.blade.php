...
@section('title', config('global.site_name').' - Actualizar Hospitalización') <!-- Título dinámico -->
@section('content')
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Actualizar hospitalización</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('emr.hospitalizations.home') }}">Hospitalizaciones</a></li>
                            <li class="breadcrumb-item active">Actualizar hospitalización</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <form id="hospitalizationForm" method="post">
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $hospitalization->id }}">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="{{ $hc->dni.' :: '.strtoupper($hc->nombres) }}" readonly>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="cama_id" id="cama_id" required>
                                            ...
                                            @foreach($beds as $b)
                                                <option value="{{ $b->id }}" {{ $hospitalization->cama_id == $b->id ? 'selected' : '' }}>{{ $b->description.' - '.$b->floor }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" id="fc" name="fc" value="{{ $hospitalization->fc ?? 'N/A' }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="t">Temperatura C / F:</label>
                                        <input class="form-control form-control-sm" id="t" name="t" value="{{ $hospitalization->t ?? 'N/A' }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="so2">Saturación de oxígeno:</label>
                                        <input class="form-control form-control-sm" id="so2" name="so2" value="{{ $hospitalization->so2 ?? 'N/A' }}" required>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm date" name="fecha_admision" id="fecha_admision" value="{{ $hospitalization->fecha_admision->format('Y-m-d') ?? now()->format('Y-m-d') }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select name="tipo_admision_id" id="tipo_admision_id">
                                            <option value="">-- Seleccione --</option>
                                            @foreach ($at as $a)
                                                <option value="{{ $a->id }}" {{ $hospitalization->tipo_admision_id == $a->id ? 'selected' : '' }}>{{ $a->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select name="via_ingreso_id" id="via_ingreso_id">
                                            <option value="">-- Seleccione --</option>
                                            @foreach ($ve as $v)
                                                <option value="{{ $v->id }}" {{ $hospitalization->via_ingreso_id == $v->id ? 'selected' : '' }}>{{ $v->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="motivo_hospitalizacion" id="motivo_hospitalizacion" rows="1">{{ $hospitalization->motivo_hospitalizacion ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="alergias" id="alergias" rows="1">{{ $hospitalization->alergias ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="medicamentos_habituales" id="medicamentos_habituales" rows="1">{{ $hospitalization->medicamentos_habituales ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="condicion_ingreso_id" id="condicion_ingreso_id">
                                                <option value="">-- Seleccione --</option>
                                                @foreach ($ec as $e)
                                                    <option value="{{ $e->id }}" {{ $hospitalization->condicion_ingreso_id == $e->id ? 'selected' : '' }}>{{ $e->nombre }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="antecedentes_importantes" id="antecedentes_importantes" rows="1">{{ $hospitalization->antecedentes_importantes ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="servicio_id" id="servicio_id">
                                                    <option value="">-- Seleccione --</option>
                                                    @foreach ($se as $s)
                                                        <option value="{{ $s->id }}" {{ $hospitalization->servicio_id == $s->id ? 'selected' : '' }}>{{ $s->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="tipo_cuidado_id" id="tipo_cuidado_id">
                                                    <option value="">-- Seleccione --</option>
                                                    @foreach ($ct as $c)
                                                        <option value="{{ $c->id }}" {{ $hospitalization->tipo_cuidado_id == $c->id ? 'selected' : '' }}>{{ $c->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm date" name="fecha_egreso" id="fecha_egreso" value="{{ $hospitalization->fecha_egreso->format('Y-m-d') ?? now()->format('Y-m-d') }}">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="tipo_egreso_id" id="tipo_egreso_id">
                                                    <option value="">-- Seleccione --</option>
                                                    @foreach ($dt as $d)
                                                        <option value="{{ $d->id }}" {{ $hospitalization->tipo_egreso_id == $d->id ? 'selected' : '' }}>{{ $d->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="diagnostico_egreso" id="diagnostico_egreso" rows="1">{{ $hospitalization->diagnostico_egreso ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="condicion_egreso_id" id="condicion_egreso_id">
                                                <option value="">-- Seleccione --</option>
                                                @foreach ($dc as $d)
                                                    <option value="{{ $d->id }}" {{ $hospitalization->condicion_egreso_id == $d->id ? 'selected' : '' }}>{{ $d->nombre }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="resumen_evolucion" id="resumen_evolucion" rows="1">{{ !empty($hospitalization->resumen_evolucion) ?$hospitalization->resumen_evolucion : 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control form-control-sm" name="causa_muerte" id="causa_muerte" rows="1">{{ $hospitalization->causa_muerte ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control form-control-sm" name="nro_autorizacion_seguro" id="nro_autorizacion_seguro" value="{{ $hospitalization->nro_autorizacion_seguro ?? 'N/A' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-sm" name="aseguradora" id="aseguradora" value="{{ strtoupper($hospitalization->aseguradora) ?? 'N/A' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="estado_hospitalizacion_id" id="estado_hospitalizacion_id">
                                                <option value="">-- Seleccione --</option>
                                                @foreach ($hs as $h)
                                                    <option value="{{ $h->id }}" {{ $hospitalization->estado_hospitalizacion_id == $h->id ? 'selected' : '' }}>{{ $h->nombre }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
